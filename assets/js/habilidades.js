...
const sobreSkill = [
                    ...
                    '<p>PHP</p> <br> <p>PHP é uma linguagem de programação de propósito geral, open source e especialmente projetada para desenvolvimento de aplicações web.</p> <br>',
                    '<p>Java</p> <br> <p>Java é uma linguagem de programação de alto nível, de propósito geral e orientada a objetos.</p> <br>',
                    '<p>SQL</p> <br> <p>SQL é uma linguagem de programação utilizada para gerenciar e manipular dados em bancos de dados relacionais.</p> <br>',
...
skills.forEach(  (elemento, index) => {
    ...
    elemento.addEventListener('mouseout', (evento, elemento,) => {
        descricao.innerHTML = 'Passe o cursor do mouse por cima de alguma habilidade para mais informações.';
    } )
} );
